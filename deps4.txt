((executables
  ((names (depgraph))
   (requires
    (0d795e4f8b0b5925c69c21e02cc9103d
     ...
     25d6d8ad0cd9c6a8ff12d45211b130ec
 ...
 (library
  ((name base)
   ...
   (source_dir /home/simmo/.opam/4.14.0/lib/base)
   (modules ())
   (include_dirs (/home/simmo/.opam/4.14.0/lib/base))))
 (library
  ((name base.base_internalhash_types)
   (uid 3803213fe04d38cea3157f466b9a8747)
   (local false)
   (requires ())
   (source_dir /home/simmo/.opam/4.14.0/lib/base/base_internalhash_types)
   (modules ())
   (include_dirs (/home/simmo/.opam/4.14.0/lib/base/base_internalhash_types))))
 (library
  ((name base.caml)
 ...
 (library
  ((name base.shadow_stdlib)
   ...
   (source_dir /home/simmo/.opam/4.14.0/lib/base/shadow_stdlib)
   (modules ())
   (include_dirs (/home/simmo/.opam/4.14.0/lib/base/shadow_stdlib))))
 (library
  ((name bigarray)
 ...
 (library
  ((name ocamlgraph_extra)
   ...
   (modules
    (((name Ocamlgraph_extra)
      (impl (_build/default/src/ocamlgraph_extra/ocamlgraph_extra.ml))
      (intf ())
      (cmt
     ...
     ((name Graphviz)
      ...
      (module_deps
       ((for_intf ())
        (for_impl ()))))
     ((name Ocamlgraph_extra__)
      (impl (_build/default/src/ocamlgraph_extra/ocamlgraph_extra__.ml-gen))
      (intf ())
      (cmt
       (_build/default/src/ocamlgraph_extra/.ocamlgraph_extra.objs/byte/ocamlgraph_extra__.cmt))
      (cmti ())
      (module_deps
       ((for_intf ())
        (for_impl ()))))))
 ...
 (library
  ((name parsexp_io)
   (uid 25d6d8ad0cd9c6a8ff12d45211b130ec)
   (local false)
   (requires
    (46774e2b7a404647f12956126bd28f95
     bcb18d7853239debd574c26458c62db7
     b5f1ee68ba5bd9694aa0f66e022e50fe))
   (source_dir /home/simmo/.opam/4.14.0/lib/parsexp_io)
   (modules ())
   (include_dirs (/home/simmo/.opam/4.14.0/lib/parsexp_io))))
 (library
 ...
 (library
  ((name stdio)
   (uid bcb18d7853239debd574c26458c62db7)
   (local false)
   (requires
    (46774e2b7a404647f12956126bd28f95 ce20dcd0c4bae81524a96662594adde2))
   (source_dir /home/simmo/.opam/4.14.0/lib/stdio)
   (modules ())
   (include_dirs (/home/simmo/.opam/4.14.0/lib/stdio))))
 (library
  ((name stdlib-shims)
